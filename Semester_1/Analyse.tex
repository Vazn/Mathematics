...
\]
De manière analogue et selon les relations d'ordre stricte ou non, on définit les intervalles \textbf{fermés et semi-ouverts}.\<
...
\begin{align*}
    &\bullet \text{ Une intersection d'intervalles est toujours un intervalle.} \\
    &\bullet \text{ Une union d'intervalles n'est en général \textbf{pas} un intervalle.}
\end{align*}
