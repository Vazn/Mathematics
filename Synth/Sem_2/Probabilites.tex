...
On considérera ici uniquement des variables aléatoires réelles, on apelle \textbf{loi} de \(X\) pour la probabilité \(\mathbb{P}\) l'application:
\[
   \begin{aligned}
   ...
   \end{aligned}
\]
C'est une mesure de probabilité sur \(E' := X(\Omega)\), le triplet \((E', \Pow(E'), \mathbb{P}_X)\) est alors un espace probabilisé à part entière et les parties de \(E'\) sont alors des \textbf{évenements}.\+
