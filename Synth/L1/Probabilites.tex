\chapter*{\chapterstyle{Dénombrement}} % 75% Fini
...
\chapter*{\chapterstyle{Espaces probabilisés}} % 75% Fini
...
\chapter*{\chapterstyle{Variables aléatoires}} % 95% Fini
...
\chapter*{\chapterstyle{Couples aléatoires}} % 95% Fini
...
\chapter*{\chapterstyle{Variables à densité}} % 95% Fini
...
\chapter*{\chapterstyle{Indicateurs}} % 95% Fini
...
\[
   \mathbox{\variance{W} := \expectancy{W^2} - \expectancy{W}^2 = \int_{I} t^2 \cdot f(t) \d t - \Bigl(\int_{I} t\cdot f(t) \d t\Bigl)^2}   
\]
