...
Il existe un unique angle \(\theta\) (modulo \(2\pi\)) tel que:
\[
...
\begin{center}
    \textbox{
        Si \textbf{l'espace entier} est engendré par \(S_n\), alors on dira que les \(F_n\) sont \textbf{supplémentaires} dans \(E\).
    }
\end{center}
