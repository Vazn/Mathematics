...
Des relations d'ordre très connues sont la relation \(\mathbox{\leq}\) sur les ensembles de nombres, ou encore la relation \(\mathbox{\subseteq}\) sur l'ensemble des parties de \(E\).\<
...
On appelle \textbf{fonction} ou \textbf{application} des cas particulier de relation entre deux ensembles.\<
