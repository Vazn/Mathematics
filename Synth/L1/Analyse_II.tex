\chapter*{\chapterstyle{Analyse II {:} Limites}} % 99% Fini
...
\chapter*{\chapterstyle{Analyse II {:} Continuité}} % 99% Fini
...
\end{center}
Exemple: Du point de vue de la topologie, un donut est une tasse c'est à dire que l'on peut déformer un donut continument pour obtenir une tasse.

\chapter*{\chapterstyle{Analyse II {:} Dérivabilité}} % 99% Fini
...
Exemple: \(f: x \mapsto x^2\) est dérivable et sa dérivée ne s'annule pas sur cet \(\icc{1}{2}\), donc elle est bijective sur \(\icc{1}{4}\) et sa réciproque est dérivable de dérivée \(\frac{1}{2\sqrt{x}}\).
...
\chapter*{\chapterstyle{Analyse II {:} Convexité}} % 99% Fini
...
\chapter*{\chapterstyle{Analyse II {:} Développements limités}} % 99% Fini
...
Exemple: La fonction \(e^\frac{1}{x}\) est définie au voisinage de \(+ \infty\), on pose \(X = \frac{1}{x}\), alors un \(DL_2(0)\) de \(f(X)\) est \(1 + X + \frac{X^2}{2}+o(X^2) = 1 + \frac{1}{x} + \frac{1}{2x^2} + o(\frac{1}{x^2})\) aprés substitution.
\pagebreak
...
\chapter*{\chapterstyle{Analyse II {:} Intégration}} % 99% Fini
...
\]
Exemple: Calculons \(I = \int_{x}^{2x} f(t) \d t\) pour \(f = \cos(3t)\). On a \(I = F(x) - F(2x)\) pour \(F = \frac{\sin(3x)}{3}\) une primitive de \(f\) donc \(I = \frac{\sin(3x) - \sin(6x)}{3}\)
...
\]
Exemple: Calculons \(I := \int e^{-x}\cos(x) \d x\)
\[
