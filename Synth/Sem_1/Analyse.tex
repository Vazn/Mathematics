...
\[
    ...
    \mathbox{
        \;\vphantom{\Bigl(\Bigl)} \exists a \in A \; ; \; M - \epsilon \leq a \leq M \;
    }
    \;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;
    \mathbox{
        \;\vphantom{\Bigl(\Bigl)}\exists (u_n) \in A^\N \; ; \; u_n \longrightarrow M \;
    }
\]
...
On peut déduire rapsidement que \textbf{toute suite convergente est de Cauchy}.\<
