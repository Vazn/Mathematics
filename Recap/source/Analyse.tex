...
\]
Soit \(m\) un majorant de \(A\), alors \(m\) est la borne supérieure de \(A\) si et seulement si:
\[
    \boxed{
    \begin{aligned}
        &\bullet \, \forall \epsilon \in \R_+ \; , \; \exists a \in A \; ; \; m - \epsilon \leq a \leq m
   \end{aligned}
      \hspace{50pt}
   \begin{aligned}
        &\bullet \, \exists (u_n) \in A^\N \; ; \; u_n \longrightarrow m
   \end{aligned}
   }
\]
